...
var SignService = function () {
    ...
    var SignService = _classThis = /** @class */ (function () {
        function SignService_1() {
        }
        SignService_1.prototype.requestFirstTimeSign = function (requestTime, secretKey, method, operatorCode) {
            var hash = (0, node_crypto_1.createHash)('md5');
        ...
        SignService_1.prototype.operatorFirstSign = function (operatorCode, requestTime, method, secretKey) {
            var hash = (0, node_crypto_1.createHash)('md5');
            hash.update(operatorCode, 'utf8');
            hash.update(String(requestTime), 'utf8');
            hash.update(method, 'utf8');
