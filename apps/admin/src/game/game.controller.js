...
var GameController = function () {
    var _classDecorators = [(0, common_1.Controller)('game')];
    ...
    var GameController = _classThis = /** @class */ (function () {
        ...
        GameController_1.prototype.create = function (createGameDto) {
            return this.gameService.create(createGameDto);
        };
        GameController_1.prototype.findAll = function () {
            return this.gameService.findAll();
        };
        GameController_1.prototype.findOne = function (id) {
            return this.gameService.findOne(+id);
        };
        GameController_1.prototype.update = function (id, updateGameDto) {
            return this.gameService.update(+id, updateGameDto);
        };
        GameController_1.prototype.remove = function (id) {
