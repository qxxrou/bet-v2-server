...
var reply_interceptor_1 = require("./interceptor/reply/reply.interceptor");
    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                config_1.ConfigModule.forRoot({
                    isGlobal: true,
                    ignoreEnvFile: true,
                    envFilePath: (0, node_path_1.resolve)(__dirname, 'admin', '.env'),
                }),
            ...
            providers: [
                {
                    ...
                    useClass: reply_interceptor_1.ReplyInterceptor,
                },
                {
